import "./App.css";
import { fullStackData, heroSection, logo, projectSection, socialLogo } from "./data";

const { logopng, li1, li2, li3, li4, li5, buttonText } = logo;
const { icon1, icon2, icon3, icon4, icon5 } = socialLogo;

const { heropng, title, subTitle, text, bannerText, dataText, text1, text2, text3, text4 } = heroSection;
      ...
      <section id="feature" className="pb-10 container mx-auto">
        <div className="container flex flex-col px-4 mx-auto mt-5 space-y-5 md:space-y-0 md:flex-row">
          ...
          <div className="flex flex-col space-y-5 md:w-1/2">
            ...
            <p className="text-center text-gray-200 sm:text-left md:pr-16 text-lg">{dataText}</p>
          ...
          <div className="flex flex-col space-y-5 md:w-1/2">
            ...
            <div className="flex flex-col space-y-3 md:space-x-6 md:space-y-0 md:flex-row">
              <div className="flex justify-center items-center rounded bg-[#e07884] md:bg-transparent">
                ...
                <h3 className="font-bold font-sans text-white md:mb-4 mx-4 md:mt-3">Frontend Skills</h3>
              </div>
            ...
            <div className="flex flex-col space-y-3 md:space-x-6 md:space-y-0 md:flex-row">
              <div className="flex justify-center items-center rounded bg-[#e07884] md:bg-transparent">
                ...
                <h3 className="font-bold font-sans text-white md:mb-4 mx-4 md:mt-3">Programming Languages</h3>
              </div>
            ...
            <div className="flex flex-col space-y-3 md:space-x-6 md:space-y-0 md:flex-row">
              <div className="flex justify-center items-center rounded bg-[#e07884] md:bg-transparent">
                ...
                <h3 className="font-bold font-sans text-white md:mb-4 mx-4 md:mt-3">Backend skills</h3>
              </div>
            ...
            <div className="flex flex-col space-y-2 md:space-x-6 md:space-y-0 md:flex-row">
              <div className="flex justify-center items-center rounded bg-[#e07884] md:bg-transparent">
                ...
                <h3 className="font-bold font-sans text-white md:mb-4 mx-4 md:mt-3">Other Skills</h3>
              </div>
            ...
            <div class="sm:flex md:grid-flow-col items-center mx-auto p-8 bg-[#a8368c] rounded-xl shadow-md space-y-4 lg:w-1/2 md:w-1/2 md:m-5 mb-5">
              ...
              <div>
                <div>
                  ...
                  <p class="text-white font-mono font-bold  py-1 px-3">{n?.title}</p>
                </div>
          ...
          {projectSection?.slice(0, 5)?.map((m) => (
            ...
            <div class="md:flex m-5 border-[#f87171] border rounded-lg">
              <div class="md:shrink-0">
                <img class="h-48 w-full object-cover md:h-full md:w-96" src={m?.proImage} alt="Man looking at item at a store" />
              </div>
              <div class="p-8">
                <div class="uppercase tracking-wide py-2 rounded-full md:py-1 text-red-400 sm:text-left">{m?.proTitle}</div>
              ...
              {m?.proSubTitle}
                ...
                <button class="font-mono px-4 py-1 border-[#f87171] border rounded-full font-normal hover:bg-[#f87171] hover:text-white transform duration-500 text-[#fde6a3]">
                  <a target="_blank" href={m?.proHref}>{m?.proButtonText}</a>
                </button>

                <button class="font-mono px-4 py-1 border-[#f87171] border rounded-full font-normal hover:bg-[#f87171] hover:text-white transform duration-500 text-[#fde6a3]">
                  <a target="_blank" href={m?.proHref1}>{m?.proButtonText1}</a>
                </button>
...
STARTED!
    ...
    <button class="font-mono px-16 py-6 bg-slate-900 border-[#f87171] border rounded-full text-2xl  font-normal hover:bg-[#f87171] hover:text-white transform duration-500 text-[#fde6a3]">
                  <a target="_blank" href="https://www.freelancer.com/u/vactormaynuddin">Getting Starterd</a>
                </button>
    </div>
  </div>
</scetion>
...
<div className="flex justify-center space-x-4">
  ...
  <a target="_blank" href="https://www.linkedin.com/in/maynuddin-bhuiyan/">
   ...
   <a target="_blank" href="https://www.facebook.com/mdmyanuddin.bhuiyan.54">
   ...
   <a target="_blank" href="https://stackoverflow.com/users/12873599/maynuddin-bhuiyan">
...
<div className="flex justify-around space-x-32">
  <div className="flex flex-col space-y-3 text-white">
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> {li1}</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> {li2}</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> {li3}</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> {li4}</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> {li5}</a>
  </div>

  <div className="flex flex-col space-y-3 text-white">
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> Careers</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> Community</a>
    <a href="" className="px-2 hover:text-[#f87171] duration-500 font-mono font-bold text-xl"> Privacy Policy</a>  
  </div>
</div>
...
<div className="flex flex-col justify-between">
  <form>
    <div className="flex space-x-3">
      <input type="text" className="flex-1 px-4 rounded-lg focus:outline-none"
      ...
      <button class="font-mono px-4 py-4 bg-slate-900 border-[#f87171] border rounded-lg text-2xl  font-normal hover:bg-[#f87171] hover:text-white transform duration-500 text-[#fde6a3]">
                  <a target="_blank" href="https://www.freelancer.com/u/vactormaynuddin">Go</a>
                </button>
    </div>
  </form>
